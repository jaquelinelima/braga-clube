<template>
    ...
    <b-button @click="$router.push('/adm_principal')" variant="primary">Voltar</b-button>
        ...
        <b-form-group id="input-group-1" label-for="input-1">
            <p>Nome:</p>
            <b-form-input id="input-1" v-model="form.email" type="name" placeholder="..." required></b-form-input>
        </b-form-group>
        ...
        <b-button type="submit" @click="$router.push('/')" variant="primary">Salvar</b-button>
      </b-form>
